...
class _MySnacksPage extends State<MySnacksPage> {
  ...
  Widget build(BuildContext context) {
    Color color1 = Theme.of(context).colorScheme.secondary;
    Color color2 = Theme.of(context).colorScheme.onSecondary;
    return SafeArea(
      child: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text("Snacks", style: TextStyle(fontSize: 30, color: color1)),
              Container(
                height: 40,
              ...
              Text("Snacks :", style: TextStyle(fontSize: 17, color: color1)),
