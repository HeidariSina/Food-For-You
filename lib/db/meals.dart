...
List<Meals> myMeals = [
  ...
  Meals(
    ...
    difficulty: "Easy",
    url: "assets/images/meals/sandwich/CapreseSandwich.jpg",
    ingredients: {
      bread: "4 Slices of Focaccia",
      sauce: "2 Tablespoon Basil Pesto",
      oliveOil: "2 Teaspoon",
      herb: "Handful of Rocket",
      cheese: "250g Mozzarella",
      tomato: "2",
      herbD1: "Handful of Basil",
      onion: "0.5 Red Onion",
      vinegar: "2 Teaspoon Balsamic",
    },
    category: "Sandwich",
    description:
  ...
  Meals(
    ...
    difficulty: "Medium",
    url: "assets/images/meals/sandwich/PulledPorkSandwich.jpg",
    ingredients: {
      onion: "2",
      herb: "3 Bay Leaves",
      powder: "1 Tablespoon Mustard Powder",
      powderD1: "1 Tablespoon Paprika",
      meat: "1.5-2Kg Pork Shoulder",
      tomato: "140g Ketchup",
      vinegar: "4 Tablespoon RedWine Vinegar",
      sauce: "1 Tablespoon Worcestershire",
      sugar: "3 Tablespoon Brown",
      bread: "2 French Stick",
    },
    category: "Sandwich",
    description:
  ...
  Meals(
    ...
    difficulty: "Easy",
    url: "assets/images/meals/sandwich/PanuozzoSandwich.jpg",
    ingredients: {
      flour: "300g",
      yeast: "3g",
      oliveOil: "1 Tablespoon",
      ...
      tomato: "1",
      meat: "4 Slices Coocked Ham",
      cheese: "150g Mozzarella",
      herb: "Handful of Rocket",
      sauce: "6 Tablespoon Pesto",
      oliveOilD1: "1 Tablespoon",
    },
    category: "Sandwich",
    description:
  ...
  Meals(
    ...
    difficulty: "Medium",
    url: "assets/images/meals/sandwich/FriedChickenSandwich.jpg",
    ingredients: {
      chicken: "5 Fillets",
      oil: "Sunflower Oil for Frying",
      info: "For the Coating",
      flour: "320g",
      flourD1: "1 Tablespoon Cornflour",
      backingPowder: "3 Teaspoon",
      pepper: "2 Teaspoon Cayenne Pepper",
      powder: "1 Tablespoon Paprika",
      powderD1: "2 Teaspoon Garlic Powder",
      egg: "3",
      infoD1: "For Buttermilk Marinade",
      milk: "300ml ButterMilk",
      powderD2: "3 Teaspoon Chili Powder",
      powderD3: "2 Teaspoon Garlic Powder",
      infoD2: "For the waffle",
      flourD2: "320g",
      backingPowderD1: "1.25 Teaspoon",
      backingSoda: "1 Teaspoon",
      sugar: "30g",
      eggD1: "3",
      milkD1: "480ml ButterMilk",
      butter: "50g",
      meatD1: "4 Strips Pancetta",
    },
    category: "Sandwich",
    description:
  ...
  Meals(
    ...
    difficulty: "Easy",
    url: "assets/images/meals/sandwich/EggCressSandwich.jpg",
    ingredients: {
      egg: "2",
      mayonnaise: "2 Tablespoon",
      bread: "3 Slices",
      butter: "a Little",
      herb: "0.33 Carton of Cress",
      tomato: "2-3 Slices",
      potato: "Potato Crisps To Sevre",
    },
    category: "Sandwich",
    description:
  ...
  Meals(
    name: "Steak Sandwich",
    difficulty: "Medium",
    url: "assets/images/meals/sandwich/SteakSandwich.jpg",
    ingredients: {
      bread: "1 Large Ciabatta",
      oliveOil: "3 Tablespoon",
      meat: "500g Sirlion Steaks",
      vinegar: "1 Teaspoon RedWine Vinegar",
      onion: "1 Red Onion",
      cheese: "100g Stilton",
      tomato: "1",
      herb: "Handfuls of Watercress",
      herbD1: "6 LittleGem Leaves",
      info: "For the Sauce",
      mayonnaise: "2 Tablespoon",
      mustard: "1 Tablespoon Dijon",
      sauce: "1-2 Teaspoon Horseradish Sauce",
    },
    category: "Sandwich",
    description:
        "Step 1 :\nMix all the sauce ingredients together with a good grind of pepper and a pinch of salt and set aside. Put a griddle pan over a high heat. Drizzle the cut side of the bread with 1 tbsp of the olive oil and griddle, pressing the top of the bread down, until the cut side is toasted and lightly charred in places. Remove from the griddle and rub the toasted side of the bread with the cut garlic. Spread the bottom slices of the bread generously with the sauce.\n\nStep 2 :\nKeeping the griddle over a high heat, rub the steaks with the vinegar, then generously season with salt and pepper and drizzle with 1 tbsp of the oil. Get your extraction fan going or open the back door or window and griddle the steaks on high for 1-2 mins on each side for rare-medium or 3 mins on each side for cooked through. As soon as the steak is done to your liking, lift onto the sauced slice of bread to rest and allow the bread to soak up the juices.\n\nStep 3 :\nMeanwhile, drizzle the onions with the rest of the oil, then griddle, pressing them down with a spatula for 3 mins on each side until charred. Lift them off and separate them into rings over the steaks, then crumble over the cheese, if using. Lay the tomato slices on top followed by the watercress or rocket, then finally the Little Gem leaves. Spread the top slices of bread with the rest of the sauce and close the sandwiches with them. Press down lightly, cut in half, if you like, and serve.",
    time: "25m",
  ),
  Meals(
    name: "Egg Mayo Sandwiches",
    difficulty: "Easy",
    url: "assets/images/meals/sandwich/EggMayoSandwiches.jpg",
    ingredients: {
      egg: "3",
      mayonnaise: "2 Tablespoon",
      yogurt: "0.5 Tablespoon Greek",
      sauce: "0.5 Tablespoon Mango Chutney",
      sauceD1: "0.5 Tablespoon Korma Curry Paste",
      onion: "2 Spring Onion",
      bean: "2 Tablespoon Coriander",
      butter: "For Spreading",
      bread: "4 Slices brown Bread",
    },
    category: "Sandwich",
    description:
  ...
  Meals(
    ...
    difficulty: "Easy",
    url: "assets/images/meals/sandwich/PloughmanSandwich.jpg",
    ingredients: {
      bread: "1 Baguette",
      mayonnaise: "2 Tablespoon",
      mustard: "1 Teaspoon Wholegrain",
      meat: "3 Slices",
      cheese: "50g",
      cucumber: "2 Tablespoon Pickle",
      herb: "Handful of Rocket",
    },
    category: "Sandwich",
    description:
  ...
  Meals(
    name: "Club Sandwich",
    difficulty: "Easy",
    url: "assets/images/meals/sandwich/ClubSandwich.jpg",
    ingredients: {
      bacon: "4 Streaky",
      bread: "3 Slices White Bread",
      mayonnaise: "1 Tablespoon",
      egg: "1 Boiled",
      tomato: "1",
      chicken: "Few Thick Slices",
      herb: "Handful Salad Leaves",
    },
    category: "Sandwich",
    description:
  ...
  Meals(
    name: "Vegan Sandwich",
    difficulty: "Easy",
    url: "assets/images/meals/sandwich/AllSandwich.jpg",
    ingredients: {
      herb: "300g Cooked Beetroot",
      bean: "400g Chickpeas",
      sauce: "3 Tablespoon Pestu",
      oliveOil: "Some",
      vinegar: "Splash of",
      bread: "2 Ciabatta Rolls",
      herb: "Handful of Rocket",
      herbD1: "Handfuls Watercress",
    },
    category: "Sandwich",
    description:
...
//     name: "",
//     difficulty: "Easy",
//     url: "assets/images/meals/sandwich/SaladeNicoise.jpg",
//     ingredients: {
//     },
//     category: "Sandwich",
//     description: "",
